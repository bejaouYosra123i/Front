...
// URLS
export const HOST_API_KEY = 'https://localhost:7190/api';
export const REGISTER_URL = '/Auth/register';
export const LOGIN_URL = '/Auth/login';
export const ME_URL = '/Auth/me';
export const UPDATE_CREDENTIALS_URL ='/Auth/update-credentials'
...
export const PATH_AFTER_UPDATE_CREDENTIALS = PATH_PUBLIC.login;